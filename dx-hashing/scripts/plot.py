...
peak_to_average_file = os.path.join(results_dir, 'dx_experiment.csv')
...
remap_removal_file = os.path.join(results_dir, 'dx_remap_removal_curve.csv')
if os.path.exists(remap_removal_file):
    ...
    plt.title('DxHash Remapping Ratio vs. Node Removal')
...
remap_addition_file = os.path.join(results_dir, 'dx_remap_addition_curve.csv')
if os.path.exists(remap_addition_file):
    ...
    plt.title('DxHash Remapping Ratio vs. Node Addition')
