...
if not df.empty:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, "rendezvous_hashing_distribution.png"))

    print(f"Plot saved to {os.path.join(output_dir, 'rendezvous_hashing_distribution.png')}")
